      ...
      <div id="event-create-container" class="col-md-6 offset-md-3">
            ...
            <form action="/events/update/{{$event->id}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" id="title" class="form-control" name="title" placeholder="Nome do Evento" value="{{$event->title}}" required>
                  </div>
                  <br>
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" id="city" class="form-control" name="city" placeholder="Local do Evento" value="{{$event->city}}"required >
                  </div>
                  <br>
                  <div class="form-group">
